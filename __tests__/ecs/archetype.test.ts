...
test('archetype', () => {
    ...
    const arch_a_id = archetypes.get_id_or_insert(components, table_id, columns, sparse_ids_ma);
    const arch_b_id = archetypes.get_id_or_insert(components, table_id, columns, sparse_ids_mb);
