import { type ArchetypeComponentId, type ScheduleGraph, Tick, type World } from "..";
import { unit } from "../../util";
import { Access } from "../query";
import { NodeConfig, type SystemConfig } from "../schedule/config";
import { NodeId } from "../schedule/graph";
import { System } from "./system";
import type { InternedSystemSet } from "../schedule/set";
import type { ProcessNodeConfig } from "../schedule/schedule";
